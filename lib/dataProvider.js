...
var getTextFromUrl = function () {
    var _ref5 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee5(strReq) {
        var ok, response;
...
var getLinesForParsing = function () {
    var _ref6 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee6(url, removeFirst) {
    ...
    (0, _createClass3.default)(DataProvider, null, [{
        ...
        value: function () {
            var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee() {
                var result, lines, lastUsedStationName, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, line, _config$stationsRegex, _config$stationsRegex2, local_id, name, lng, lat;
                        ...
                        switch (_context4.prev = _context4.next) {
                            ...
                            case 3:
                                ...
                                lines.forEach(function (line, index) {
                                    if (index % 2 === 0) local_id = parseInt(line);else {
                                        result.push({
                                            local_id: local_id,
                                            polyline: _polyline2.default.decode(line).map(function (item) {
